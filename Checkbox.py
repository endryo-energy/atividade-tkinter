...
def enviar():
    ...
    if var_politicas.get():
        print("Usuário concordou com os Termos de Uso e as Politicas de Privacidade")
    else:
        print("Usuário NÃO concordou com os Termos de Uso e as Politicas de Privacidade")
